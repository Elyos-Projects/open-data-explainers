...
> Status: Decomposed · Version: 0.2.0 · Last updated: 2026-06-29 · Owner: TBD (maintainer) · Lane: donated
...
```json
{
  ...
  "resources": [
    "C:\\code\\hee-lee-oss\\planning\\projects\\open-data-explainers\\PLAN.md",
    "C:\\code\\hee-lee-oss\\governance\\proposals\\open-data-explainers.md",
...
All backlog rows have been decomposed into `tasks/*.json` files (schema-validated). Items marked **[decomposed]**.

| Task ID | Title | Milestone | Status |
| --- | --- | --- | --- |
| open-data-explainers-reviewers-001 | Name/secure the License and Methodology+Stats reviewers (blocking gate roles) | M0 | [decomposed] |
| open-data-explainers-toolkit-002 | Shared explainer toolkit (adapter interface, derivation pipeline, static tool scaffold, golden-fixture harness) | M0 | [decomposed] |
| open-data-explainers-gate-003 | License + provenance + output-license + PII/aggregation gate checklist | M0 | [decomposed] |
| open-data-explainers-methodcard-004 | Methodology Card schema + Sources-&-limits + non-partisan/"not advice" template | M0 | [decomposed] |
| open-data-explainers-a11y-005 | Accessibility + plain-language standard (WCAG 2.2 AA, reading grade <= 8) | M0 | [decomposed] |
| open-data-explainers-regionrubric-006 | Region-selection rubric + harm-scan checklist | M0 | [decomposed] |
| open-data-explainers-outreach-007 | Beneficiary/distribution outreach + pilot acceptance-path | M0 | [decomposed] |
| open-data-explainers-pilot-008 | Pilot: one county-ag profile explainer end-to-end (USDA NASS) | M0 | [decomposed] |
| open-data-explainers-cpi-009 | CPI inflation-by-category explainer (national, BLS) | M1 | [decomposed] |
| open-data-explainers-college-010 | College-outcomes-explorer (College Scorecard) — not a ranking, not advice | M1 | [decomposed] |
| open-data-explainers-countyag-011 | County-ag profiles batch (N counties via the pilot template) | M1 | [decomposed] |
| open-data-explainers-corrections-012 | Public corrections process + changelog convention | M1 | [decomposed] |
| open-data-explainers-partner-013 | Secure first confirmed distribution partner | M1 | [decomposed] |
| open-data-explainers-transit-method-014 | Transit-access score definition + methodology (walk threshold, network, frequency) | M2 | [decomposed] |
| open-data-explainers-transit-015 | Transit-access explainer for >= 1 metro (GTFS, per-feed license verified) | M2 | [decomposed] |
| open-data-explainers-osmkit-016 | OSM ODbL share-alike output kit (derived-DB vs produced-work, attribution) | M2 | [decomposed] |
| open-data-explainers-amenities-017 | Amenities-near-me derived POI set for >= 1 area (OSM, ODbL output) | M2 | [decomposed] |
| open-data-explainers-collision-018 | Collision-hotspots explainer for >= 1 area (STATS19, aggregate-only) | M2 | [decomposed] |
| open-data-explainers-astro-019 | Astronomy lesson from sky-survey data (SDSS/Gaia, educator-reviewed) | M3 | [decomposed] |
| open-data-explainers-reuse-020 | Track and verify external reuse/usage outcomes | M3 | [decomposed] |
| open-data-explainers-refresh-021 | Staleness/refresh process + data-currency badges + drift detection | M3 | [decomposed] |
| open-data-explainers-i18n-022 | Translate a delivered explainer (domain/language reviewer) | Backlog | [decomposed] |
| open-data-explainers-gtfs-catalog-023 | GTFS multi-feed license catalog + scaling | Backlog | [decomposed] |
| open-data-explainers-dash-024 | Outcome/usage dashboard (privacy-preserving, aggregate) | Backlog | [decomposed] |
| open-data-explainers-collision-trends-025 | Multi-year collision trend explainers (aggregate) | Backlog | [decomposed] |
| open-data-explainers-college-region-026 | Regional college-affordability explainers | Backlog | [decomposed] |

_Generated by Hee-Lee Oss task-decomposition agent on 2026-06-29. All 26 task files schema-validated (validate-tasks.mjs: ALL VALID)._
